...
The WeCom gateway connects Pi Cloud to organization members through a self-built WeCom application. This version supports text messages and slash commands; image support is planned for a later version.

## Setup

1. Create a self-built application in the WeCom administration console and note its Corp ID, Agent ID, and Secret.
...
4. In the application's message callback settings, paste all three values and save. The Pi Cloud status changes to **Callback verified** after WeCom verifies or delivers a callback.
